...
function Ue(e) {
    ...
    return ("TURBOPACK compile-time value", "undefined") < "u" ? re(w(p({}, e), {
        opts: r
    })) : ne(w(p({}, e), {
        opts: r
    }));
...
;
;
const v = ()=>typeof WebSocket < "u" ? WebSocket : ("TURBOPACK compile-time value", "object") < "u" && typeof /*TURBOPACK member replacement*/ __turbopack_context__.g.WebSocket < "u" ? /*TURBOPACK member replacement*/ __turbopack_context__.g.WebSocket : ("TURBOPACK compile-time value", "undefined") < "u" && typeof window.WebSocket < "u" ? window.WebSocket : typeof self < "u" && typeof self.WebSocket < "u" ? self.WebSocket : __turbopack_context__.r("[project]/node_modules/ws/index.js [app-ssr] (ecmascript)"), w = ()=>typeof WebSocket < "u" || ("TURBOPACK compile-time value", "object") < "u" && typeof /*TURBOPACK member replacement*/ __turbopack_context__.g.WebSocket < "u" || ("TURBOPACK compile-time value", "undefined") < "u" && typeof window.WebSocket < "u" || typeof self < "u" && typeof self.WebSocket < "u", d = (r)=>r.split("?")[0], h = 10, b = v();
class f {
    constructor(e){
...
function Ot(e) {
    return e != null && typeof e != "function" && Pt(e.length);
}
function It(e) {
    return e === "__proto__";
}
...
const St = "[object RegExp]", W = "[object String]", J = "[object Number]", K = "[object Boolean]", V = "[object Arguments]", bt = "[object Symbol]", At = "[object Date]", vt = "[object Map]", Et = "[object Set]", $t = "[object Array]", Nt = "[object ArrayBuffer]", Y = "[object Object]", Ct = "[object DataView]", _t = "[object Uint8Array]", qt = "[object Uint8ClampedArray]", Rt = "[object Uint16Array]", Dt = "[object Uint32Array]", Ft = "[object Int8Array]", xt = "[object Int16Array]", Ut = "[object Int32Array]", Ht = "[object Float32Array]", jt = "[object Float64Array]";
function $(e) {
    return ArrayBuffer.isView(e) && !(e instanceof DataView);
}
function Bt(e, t) {
    return f(e, void 0, e, new Map, t);
}
function f(e, t, s, i = new Map, r = void 0) {
    const a = r?.(e, t, s, i);
    ...
    if (Array.isArray(e)) {
        ...
        i.set(e, n);
        for(let c = 0; c < e.length; c++)n[c] = f(e[c], c, s, i, r);
    ...
    if (e instanceof Map) {
        const n = new Map;
        i.set(e, n);
        for (const [c, o] of e)n.set(c, f(o, c, s, i, r));
        return n;
    }
    if (e instanceof Set) {
        const n = new Set;
        i.set(e, n);
        for (const c of e)n.add(f(c, void 0, s, i, r));
        return n;
    }
    ...
    if (e instanceof DataView) {
        ...
        return i.set(e, n), d(n, e, s, i, r), n;
    }
    ...
    if (e instanceof Error) {
        ...
        return i.set(e, n), n.message = e.message, n.name = e.name, n.stack = e.stack, n.cause = e.cause, d(n, e, s, i, r), n;
    }
...
function d(e, t, s = e, i, r) {
    const a = [
        ...Object.keys(t),
        ...G(t)
    ];
    for(let n = 0; n < a.length; n++){
        const c = a[n], o = Object.getOwnPropertyDescriptor(e, c);
        (o == null || o.writable) && (e[c] = f(t[c], c, s, i, r));
    }
}
function Lt(e) {
    switch(E(e)){
...
function Mt(e, t) {
    return Bt(e, (s, i, r, a)=>{
        if (typeof e == "object") {
            if (E(e) === Y && typeof e.constructor != "function") {
                const n = {};
                return a.set(e, n), d(n, e, r, a), n;
            }
            switch(Object.prototype.toString.call(e)){
                ...
                case V:
                    {
                        const n = {};
                        return d(n, e), n.length = e.length, n[Symbol.iterator] = e[Symbol.iterator], n;
                    }
                default:
                    return;
            }
...
function Q(e) {
    return e !== null && typeof e == "object" && E(e) === "[object Arguments]";
}
function N(e) {
...
function _(e) {
    ...
    if (Object.prototype.toString.call(e) !== "[object Object]") {
        const s = e[Symbol.toStringTag];
        return s == null || !Object.getOwnPropertyDescriptor(e, Symbol.toStringTag)?.writable ? !1 : e.toString() === `[object ${s}]`;
    }
    let t = e;
...
function Wt(e) {
    if (v(e)) return e;
    if (Array.isArray(e) || $(e) || e instanceof ArrayBuffer || typeof SharedArrayBuffer < "u" && e instanceof SharedArrayBuffer) return e.slice(0);
    const t = Object.getPrototypeOf(e);
    if (t == null) return Object.assign(Object.create(t), e);
    const s = t.constructor;
    if (e instanceof Date || e instanceof Map || e instanceof Set) return new s(e);
    if (e instanceof RegExp) {
        const i = new s(e);
        return i.lastIndex = e.lastIndex, i;
    }
    if (e instanceof DataView) return new s(e.buffer.slice(0));
    if (e instanceof Error) {
        let i;
        return e instanceof AggregateError ? i = new s(e.errors, e.message, {
            cause: e.cause
        }) : i = new s(e.message, {
            cause: e.cause
        }), i.stack = e.stack, Object.assign(i, e), i;
    }
    if (typeof File < "u" && e instanceof File) return new s([
        e
    ], e.name, {
        type: e.type,
...
function Jt(e, ...t) {
    const s = t.slice(0, -1), i = t[t.length - 1];
    let r = e;
...
function P(e, t, s, i) {
    if (v(e) && (e = Object(e)), t == null || typeof t != "object") return e;
    if (i.has(t)) return Wt(i.get(t));
    ...
    for(let a = 0; a < r.length; a++){
        ...
        if (Q(c) && (c = {
            ...
            ...o
        }), typeof Buffer < "u" && Buffer.isBuffer(c) && (c = X(c)), Array.isArray(c)) if (Array.isArray(o)) {
            const p = [], h = Reflect.ownKeys(o);
            ...
            const p = [];
            for(let h = 0; h < o.length; h++)p[h] = o[h];
            o = p;
        } else o = [];
        const u = s(o, c, n, e, t, i);
        u !== void 0 ? e[n] = u : Array.isArray(c) || N(o) && N(c) && (_(o) || _(c) || C(o) || C(c)) ? e[n] = P(o, c, s, i) : o == null && _(c) ? e[n] = P({}, c, s, i) : o == null && C(c) ? e[n] = X(c) : (o === void 0 || c !== void 0) && (e[n] = c);
    }
    return e;
}
function Kt(e, ...t) {
...
const Z = "error", Vt = "wss://relay.walletconnect.org", Yt = "wc", k = "universal_provider", O = `${Yt}@2:${k}:`, T = "https://rpc.walletconnect.org/v1/", tt = "generic", Xt = `${T}bundler`, l = "call_status", Qt = 86400, q = {
    DEFAULT_CHAIN_CHANGED: "default_chain_changed"
};
function et(e, t, s) {
    const i = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseChainId"])(e);
    return t.rpcMap?.[i.reference] || `${T}?chainId=${i.namespace}:${i.reference}&projectId=${s}`;
}
function Zt(e) {
...
function kt(e, t) {
    const s = Object.keys(t.namespaces).filter((r)=>r.includes(e));
    if (!s.length) return [];
    const i = [];
    return s.forEach((r)=>{
...
function it(e) {
    return Object.fromEntries(Object.entries(e).filter(([t, s])=>s?.chains?.length && s?.chains?.length > 0));
}
function I(e = {}, t = {}) {
    const s = it(nt(e)), i = it(nt(t));
    return Kt(s, i);
}
function nt(e) {
    const t = {};
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidObject"])(e)) return t;
    for (const [s, i] of Object.entries(e)){
        const r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isCaipNamespace"])(s) ? [
            s
        ] : i.chains, a = i.methods || [], n = i.events || [], c = i.rpcMap || {}, o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(s);
        t[o] = {
            ...t[o],
            ...i,
            chains: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mergeArrays"])(r, t[o]?.chains),
            methods: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mergeArrays"])(a, t[o]?.methods),
            events: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mergeArrays"])(n, t[o]?.events)
        }, ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidObject"])(c) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidObject"])(t[o]?.rpcMap || {})) && (t[o].rpcMap = {
            ...c,
            ...t[o]?.rpcMap
        });
    }
...
function at(e) {
    ...
    for (const [s, i] of Object.entries(e)){
        const r = i.methods || [], a = i.events || [], n = i.accounts || [], c = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isCaipNamespace"])(s) ? [
            s
        ] : i.chains ? i.chains : st(i.accounts);
        t[s] = {
            chains: c,
            methods: r,
            events: a,
...
const ct = {}, m = (e)=>ct[e], D = (e, t)=>{
    ...
    "sessionKeys",
    "auxiliaryFunds"
], ee = (e)=>e && e.startsWith("0x") ? BigInt(e).toString(10) : e, F = (e)=>e && e.startsWith("0x") ? e : `0x${BigInt(e).toString(16)}`, ht = (e)=>Object.keys(e).filter((t)=>te.includes(t)).reduce((t, s)=>(t[s] = se(e[s]), t), {}), se = (e)=>typeof e == "string" && Tt(e) ? JSON.parse(e) : e, ie = (e, t, s)=>{
    const { sessionProperties: i = {}, scopedProperties: r = {} } = e, a = {};
...
class U {
    ...
    async setItem(t, s) {
        return await this.storage.setItem(t, s);
    }
    async removeItem(t) {
        return await this.storage.removeItem(t);
    }
    static getStorage(t) {
        return x || (x = new U(t)), x;
    }
}
async function ne(e, t) {
    const s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseChainId"])(e.result.capabilities.caip345.caip2), i = e.result.capabilities.caip345.transactionHashes, r = await Promise.allSettled(i.map((h)=>re(s.reference, h, t))), a = r.filter((h)=>h.status === "fulfilled").map((h)=>h.value).filter((h)=>h);
    r.filter((h)=>h.status === "rejected").forEach((h)=>console.warn("Failed to fetch transaction receipt:", h.reason));
    const n = !a.length || a.some((h)=>!h), c = a.every((h)=>h?.status === "0x1"), o = a.every((h)=>h?.status === "0x0"), u = a.some((h)=>h?.status === "0x0");
    let p;
    return n ? p = 100 : c ? p = 200 : o ? p = 500 : u && (p = 600), {
        id: e.result.id,
...
async function re(e, t, s) {
    return await s(parseInt(e)).request((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$utils$2f$dist$2f$esm$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatJsonRpcRequest"])("eth_getTransactionReceipt", [
        t
    ]));
}
async function ae({ sendCalls: e, storage: t }) {
    const s = await t.getItem(l);
    await t.setItem(l, {
        ...s,
        [e.result.id]: {
            request: e.request,
            result: e.result,
            expiry: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calcExpiry"])(Qt)
        }
    });
}
async function ce({ resultId: e, storage: t }) {
    const s = await t.getItem(l);
    if (s) {
        delete s[e], await t.setItem(l, s);
...
async function oe({ resultId: e, storage: t }) {
    const s = (await t.getItem(l))?.[e];
    if (s && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isExpired"])(s.expiry)) return s;
    await ce({
        resultId: e,
        storage: t
    });
...
class he {
    constructor(t){
        this.name = "eip155", this.namespace = t.namespace, this.events = m("events"), this.client = m("client"), this.httpProviders = this.createHttpProviders(), this.chainId = parseInt(this.getDefaultChain()), this.storage = U.getStorage(this.client.core.storage);
    }
    async request(t) {
    ...
    setDefaultChain(t, s) {
        this.httpProviders[t] || this.setHttpProvider(parseInt(t), s);
        const i = this.chainId;
        this.chainId = parseInt(t), this.events.emit(q.DEFAULT_CHAIN_CHANGED, {
            currentCaipChainId: `${this.name}:${t}`,
    ...
    createHttpProvider(t, s) {
        const i = s || et(`${this.name}:${t}`, this.namespace, this.client.core.projectId);
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$provider$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["JsonRpcProvider"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$http$2d$connection$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HttpConnection"](i, m("disableProviderPing")));
    }
    setHttpProvider(t, s) {
        const i = this.createHttpProvider(t, s);
        i && (this.httpProviders[t] = i);
    }
    createHttpProviders() {
        const t = {};
        return this.namespace.chains.forEach((s)=>{
            const i = parseInt(Zt(s));
            t[i] = this.createHttpProvider(i, this.namespace.rpcMap?.[s]);
        }), t;
    }
    getAccounts() {
        const t = this.namespace.accounts;
        return t ? [
            ...new Set(t.filter((s)=>s.split(":")[1] === this.chainId.toString()).map((s)=>s.split(":")[2]))
        ] : [];
    }
    getHttpProvider(t) {
        const s = t || this.chainId;
        return this.httpProviders[s] || (this.httpProviders = {
            ...this.httpProviders,
            [s]: this.createHttpProvider(s)
        }, this.httpProviders[s]);
    }
    async handleSwitchChain(t) {
        let s = t.request.params ? t.request.params[0]?.chainId : "0x0";
    ...
    async getCapabilities(t) {
        const s = t.request?.params?.[0], i = t.request?.params?.[1] || [];
        if (!s) throw new Error("Missing address parameter in `wallet_getCapabilities` request");
        const r = this.client.session.get(t.topic), a = r?.sessionProperties?.capabilities || {}, n = i.length > 0 ? i.join(",") : `0x${this.chainId.toString(16)}`, c = `${s}${n}`, o = a?.[c];
        if (o) return o;
        let u;
        try {
            u = ie(r, s, i);
        } catch (h) {
            console.warn("Failed to extract capabilities from session", h);
        }
        if (u) return u;
    ...
    async getCallStatus(t) {
        const s = this.client.session.get(t.topic), i = s.sessionProperties?.bundler_name;
        if (i) {
            const n = this.getBundlerUrl(t.chainId, i);
            try {
                return await this.getUserOperationReceipt(n, t);
            } catch (c) {
                console.warn("Failed to fetch call status from bundler", c, n);
            }
        }
        const r = s.sessionProperties?.bundler_url;
        if (r) try {
            return await this.getUserOperationReceipt(r, t);
        } catch (n) {
            console.warn("Failed to fetch call status from custom bundler", n, r);
        }
        const a = await oe({
            resultId: t.request.params?.[0],
            storage: this.storage
        });
        if (a) try {
            return await ne(a, this.getHttpProvider.bind(this));
        } catch (n) {
            console.warn("Failed to fetch call status from stored send calls", n, a);
        }
        if (this.namespace.methods.includes(t.request.method)) return await this.client.request(t);
        throw new Error("Fetching call status not approved by the wallet.");
    }
    async getUserOperationReceipt(t, s) {
        const i = new URL(t), r = await fetch(i, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    getBundlerUrl(t, s) {
        return `${Xt}?projectId=${this.client.core.projectId}&chainId=${t}&bundler=${s}`;
    }
    async sendCalls(t) {
        const s = await this.client.request(t), i = t.request.params?.[0], r = s?.id, a = s?.capabilities || {}, n = a?.caip345?.caip2, c = a?.caip345?.transactionHashes;
        return !r || !n || !c?.length || await ae({
            sendCalls: {
                request: i,
                result: s
            },
...
class pe {
    constructor(t){
        this.name = tt, this.namespace = t.namespace, this.events = m("events"), this.client = m("client"), this.chainId = this.getDefaultChain(), this.name = this.getNamespaceName(), this.httpProviders = this.createHttpProviders();
    }
    updateNamespace(t) {
    ...
    setDefaultChain(t, s) {
        this.httpProviders[t] || this.setHttpProvider(t, s);
        const i = this.chainId;
        this.chainId = t, this.events.emit(q.DEFAULT_CHAIN_CHANGED, {
            currentCaipChainId: `${this.name}:${t}`,
            previousCaipChainId: `${this.name}:${i}`
        });
    }
    ...
    getNamespaceName() {
        const t = this.namespace.chains[0];
        if (!t) throw new Error("ChainId not found");
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseChainId"])(t).namespace;
    }
    getAccounts() {
        const t = this.namespace.accounts;
        return t ? [
    ...
    createHttpProviders() {
        const t = {};
        return this.namespace?.accounts?.forEach((s)=>{
            const i = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseChainId"])(s), r = this.namespace?.rpcMap?.[`${i.namespace}:${i.reference}`];
            t[i.reference] = this.createHttpProvider(s, r);
        }), t;
    }
    getHttpProvider(t) {
        const s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseChainId"])(t).reference, i = this.httpProviders[s];
        if (typeof i > "u") throw new Error(`JSON-RPC provider for ${t} not found`);
        return i;
    }
    setHttpProvider(t, s) {
        const i = this.createHttpProvider(t, s);
    ...
    createHttpProvider(t, s) {
        const i = s || et(t, this.namespace, this.client.core.projectId);
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$provider$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["JsonRpcProvider"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$http$2d$connection$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"](i, m("disableProviderPing")));
    }
}
let pt = class ut {
    constructor(t){
        this.events = new __TURBOPACK__imported__module__$5b$externals$5d2f$events__$5b$external$5d$__$28$events$2c$__cjs$29$__["default"], this.rpcProviders = {}, this.disableProviderPing = !1, this.providerOpts = t, this.logger = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createLogger"])({
            logger: t.logger ?? Z,
            name: this.providerOpts.name ?? k
    ...
    sendAsync(t, s, i, r) {
        ...
        this.request(t, i, r).then((n)=>s(null, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$utils$2f$dist$2f$esm$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatJsonRpcResult"])(a, n))).catch((n)=>s(n, void 0));
    }
    async enable() {
    ...
    async connect(t) {
        if (!this.client) throw new Error("Sign Client not initialized");
        if (this.connectParams = t, this.setNamespaces(t), this.cleanupPendingPairings(), !t.skipPairing) return await this.pair(t.pairingTopic);
    }
    async authenticate(t, s) {
        if (!this.client) throw new Error("Sign Client not initialized");
        this.setNamespaces(t), await this.cleanupPendingPairings();
        const { uri: i, response: r } = await this.client.authenticate(t, s);
        i && (this.uri = i, this.events.emit("display_uri", i));
        const a = await r();
        if (this.session = a.session, this.session) {
            const n = at(this.session.namespaces);
            this.namespaces = I(this.namespaces, n), await this.persist("namespaces", this.namespaces), this.onConnect();
        }
        return a;
    }
    on(t, s) {
    ...
    async pair(t) {
        ...
        const r = await i();
        this.session = r;
        const a = at(r.namespaces);
        return this.namespaces = I(this.namespaces, a), await this.persist("namespaces", this.namespaces), await this.persist("optionalNamespaces", this.optionalNamespaces), this.onConnect(), this.session;
    }
    setDefaultChain(t, s) {
        try {
            if (!this.session) return;
            const [i, r] = this.validateChain(t), a = this.getProvider(i);
            a ? a.setDefaultChain(r, s) : this.session && this.logger.warn(`Provider for namespace '${i}' not found in setDefaultChain`);
        } catch (i) {
    ...
    async cleanupPendingPairings(t = {}) {
        try {
            ...
            for (const i of s)t.deletePairings ? this.client.core.expirer.set(i.topic, 0) : await this.client.core.relayer.subscriber.unsubscribe(i.topic);
    ...
    async createClient() {
        if (this.client = this.providerOpts.client || await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$sign$2d$client$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignClient"].init({
            ...
            relayUrl: this.providerOpts.relayUrl || Vt,
            ...
            throw this.logger.error(t, "Failed to get session"), new Error(`The provided session: ${this.providerOpts?.session?.topic} doesn't exist in the Sign client`);
        }
        else {
            const t = this.client.session.getAll();
            this.session = t[0];
        }
    ...
    createProviders() {
        ...
        D("client", this.client), D("events", this.events), D("disableProviderPing", this.disableProviderPing), t.forEach((s)=>{
            if (!this.session) return;
            const i = kt(s, this.session);
            if (i?.length === 0) return;
            const r = st(i), a = {
                ...I(this.namespaces, this.optionalNamespaces)[s],
                accounts: i,
                chains: r
            };
            switch(s){
                case "eip155":
                    this.rpcProviders[s] = new he({
                        namespace: a
                    });
                    break;
                default:
    ...
    registerEventListeners() {
        ...
        this.client.on("session_ping", (t)=>{
            const { topic: s } = t;
            s === this.session?.topic && this.events.emit("session_ping", t);
        }), this.client.on("session_event", (t)=>{
            const { params: s, topic: i } = t;
            if (i !== this.session?.topic) return;
            const { event: r } = s;
            if (r.name === "accountsChanged") {
                const a = r.data;
                a && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidArray"])(a) && this.events.emit("accountsChanged", a.map(rt));
            } else if (r.name === "chainChanged") {
                const a = s.chainId, n = s.event.data, c = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(a), o = R(a) !== R(n) ? `${c}:${R(n)}` : a;
                this.onChainChanged({
                    currentCaipChainId: o
                });
            } else this.events.emit(r.name, r.data);
            this.events.emit("session_event", t);
        }), this.client.on("session_update", ({ topic: t, params: s })=>{
            if (t !== this.session?.topic) return;
            const { namespaces: i } = s, r = this.client?.session.get(t);
            this.session = {
                ...r,
                namespaces: i
            ...
            t.topic === this.session?.topic && (await this.cleanup(), this.events.emit("session_delete", t), this.events.emit("disconnect", {
                ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSdkError"])("USER_DISCONNECTED"),
                data: t.topic
            }));
        }), this.on(q.DEFAULT_CHAIN_CHANGED, (t)=>{
            this.onChainChanged({
                ...t,
                internal: !0
            });
    ...
    getProvider(t) {
        return this.rpcProviders[t] || this.rpcProviders[tt];
    }
    onSessionUpdate() {
    ...
    setNamespaces(t) {
        const { namespaces: s = {}, optionalNamespaces: i = {}, sessionProperties: r, scopedProperties: a } = t;
        this.optionalNamespaces = I(s, i), this.sessionProperties = r, this.scopedProperties = a;
    }
    validateChain(t) {
        const [s, i] = t?.split(":") || [
            "",
    ...
    async onChainChanged({ currentCaipChainId: t, previousCaipChainId: s, internal: i = !1 }) {
        if (!this.namespaces) return;
        const [r, a] = this.validateChain(t);
        if (a) {
            if (this.updateNamespaceChain(r, a), i) this.events.emit("chainChanged", a), this.emitAccountsChangedOnChainChange({
                namespace: r,
                ...
                n ? n.setDefaultChain(a) : this.session && this.logger.warn(`Provider for namespace '${r}' not found during chain change`);
            }
            await this.persist("namespaces", this.namespaces);
        }
    }
    emitAccountsChangedOnChainChange({ namespace: t, currentCaipChainId: s, previousCaipChainId: i }) {
        try {
            if (i === s) return;
            const r = this.session?.namespaces[t]?.accounts;
            if (!r) return;
            const a = r.filter((n)=>n.includes(`${s}:`)).map(rt);
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidArray"])(a)) return;
            this.events.emit("accountsChanged", a);
        } catch (r) {
            this.logger.warn(r, "Failed to emit accountsChanged on chain change");
        }
    }
    updateNamespaceChain(t, s) {
        if (!this.namespaces) return;
        const i = this.namespaces[t] ? t : `${t}:${s}`, r = {
            chains: [],
            methods: [],
            events: [],
            defaultChain: s
    ...
    async persist(t, s) {
        const i = this.session?.topic || "";
        await this.client.core.storage.setItem(`${O}/${t}${i}`, s);
    }
    async getFromStore(t) {
        const s = this.session?.topic || "";
        return await this.client.core.storage.getItem(`${O}/${t}${s}`);
    }
    async deleteFromStore(t) {
        const s = this.session?.topic || "";
        await this.client.core.storage.removeItem(`${O}/${t}${s}`);
    }
    async cleanupStorage() {
        try {
            if (this.client?.session.length > 0) return;
            const t = await this.client.core.storage.getKeys();
            for (const s of t)s.startsWith(O) && await this.client.core.storage.removeItem(s);
        } catch (t) {
...
;
;
const O = "wc", S = "ethereum_provider", T = `${O}@2:${S}:`, R = "https://rpc.walletconnect.org/v1/", p = [
    "eth_sendTransaction",
    "personal_sign"
], f = [
    "eth_accounts",
    ...
    const { createAppKit: i } = await __turbopack_context__.A("[project]/node_modules/@reown/appkit/dist/esm/exports/core.js [app-ssr] (ecmascript, async loader)");
    return i;
};
function g(i) {
...
function x(i) {
    const { chains: t, optionalChains: e, methods: s, optionalMethods: n, events: a, optionalEvents: o, rpcMap: r } = i;
    ...
    }, c = a?.filter((w)=>!m.includes(w)), d = s?.filter((w)=>!p.includes(w));
    if (!e && !o && !n && !c?.length && !d?.length) return {
        required: t.length ? h : void 0
    };
    const l = c?.length && d?.length || !e, y = {
        chains: [
            ...new Set(l ? h.chains.concat(e || []) : e)
        ],
        methods: [
            ...new Set(h.methods.concat(n?.length ? n : f))
        ],
        events: [
            ...new Set(h.events.concat(o?.length ? o : v))
        ],
        rpcMap: r
    };
    return {
        required: t.length ? h : void 0,
        optional: e.length ? y : void 0
    };
}
let E = class b {
    constructor(){
        this.events = new __TURBOPACK__imported__module__$5b$externals$5d2f$events__$5b$external$5d$__$28$events$2c$__cjs$29$__["EventEmitter"], this.namespace = "eip155", this.accounts = [], this.chainId = 1, this.STORAGE_KEY = T, this.on = (t, e)=>(this.events.on(t, e), this), this.once = (t, e)=>(this.events.once(t, e), this), this.removeListener = (t, e)=>(this.events.removeListener(t, e), this), this.off = (t, e)=>(this.events.off(t, e), this), this.parseAccount = (t)=>this.isCompatibleChainId(t) ? this.parseAccountId(t).address : t, this.signer = {}, this.rpc = {};
    }
    static async init(t) {
        const e = new b;
    ...
    async connect(t) {
        ...
        const { required: e, optional: s } = x(this.rpc);
        try {
            const n = await new Promise(async (o, r)=>{
                this.rpc.showQrModal && (this.modal?.open(), this.modal?.subscribeState((c)=>{
                    !c.open && !this.signer.session && (this.signer.abortPairingAttempt(), r(new Error("Connection request reset. Please try again.")));
                }));
                const h = t?.scopedProperties ? {
                ...
                await this.signer.connect({
                    ...
                    this.modal?.showErrorMessage("Unable to connect"), r(new Error(c.message));
                });
            });
            if (!n) return;
            const a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccountsFromNamespaces"])(n.namespaces, [
                this.namespace
            ]);
    ...
    async authenticate(t, e) {
        ...
        try {
            const s = await new Promise(async (a, o)=>{
                this.rpc.showQrModal && (this.modal?.open(), this.modal?.subscribeState((r)=>{
                    !r.open && !this.signer.session && (this.signer.abortPairingAttempt(), o(new Error("Connection request reset. Please try again.")));
                    ...
                    this.modal?.showErrorMessage("Unable to connect"), o(new Error(r.message));
                });
            }), n = s.session;
            if (n) {
                const a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccountsFromNamespaces"])(n.namespaces, [
    ...
    registerEventListeners() {
        this.signer.on("session_event", (t)=>{
            ...
            const e = parseInt(t);
            this.chainId = e, this.events.emit("chainChanged", u(this.chainId)), this.persist();
        }), this.signer.on("session_update", (t)=>{
            this.events.emit("session_update", t);
        }), this.signer.on("session_delete", (t)=>{
            this.reset(), this.events.emit("session_delete", t), this.events.emit("disconnect", {
                ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSdkError"])("USER_DISCONNECTED"),
                data: t.topic,
    ...
    setChainIds(t) {
        ...
        e.length && (this.chainId = e[0], this.events.emit("chainChanged", u(this.chainId)), this.persist());
    }
    setChainId(t) {
    ...
    getRpcConfig(t) {
        const e = t?.chains ?? [], s = t?.optionalChains ?? [], n = e.concat(s);
        if (!n.length) throw new Error("No chains specified in either `chains` or `optionalChains`");
        const a = e.length ? t?.methods || p : [], o = e.length ? t?.events || m : [], r = t?.optionalMethods || [], h = t?.optionalEvents || [], c = t?.rpcMap || this.buildRpcMap(n, t.projectId), d = t?.qrModalOptions || void 0;
        return {
            chains: e?.map((l)=>this.formatChainId(l)),
            optionalChains: s.map((l)=>this.formatChainId(l)),
            methods: a,
            events: o,
            optionalMethods: r,
            optionalEvents: h,
            rpcMap: c,
            showQrModal: !!t?.showQrModal,
            qrModalOptions: d,
    ...
    async initialize(t) {
        if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? g(this.rpc.chains) : g(this.rpc.optionalChains), this.signer = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$universal$2d$provider$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UniversalProvider"].init({
            ...
            let e;
            try {
                const s = await W(), { convertWCMToAppKitOptions: n } = await Promise.resolve().then(function() {
                    return U;
                }), a = n({
                ...
                e = s({
                    ...
                    manualWCControl: !0,
                    enableMobileFullScreen: this.rpc.qrModalOptions?.enableMobileFullScreen === !0
                });
            } catch (s) {
    ...
    loadConnectOpts(t) {
        if (!t) return;
        const { chains: e, optionalChains: s, rpcMap: n } = t;
        e && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidArray"])(e) && (this.rpc.chains = e.map((a)=>this.formatChainId(a)), e.forEach((a)=>{
            this.rpc.rpcMap[a] = n?.[a] || this.getRpcUrl(a);
        })), s && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidArray"])(s) && (this.rpc.optionalChains = [], this.rpc.optionalChains = s?.map((a)=>this.formatChainId(a)), s.forEach((a)=>{
            this.rpc.rpcMap[a] = n?.[a] || this.getRpcUrl(a);
        }));
    }
    getRpcUrl(t, e) {
        return this.rpc.rpcMap?.[t] || `${R}?chainId=eip155:${t}&projectId=${e || this.rpc.projectId}`;
    }
...
function q(i) {
    const t = i.chains?.map(k).filter(Boolean);
    if (t.length === 0) throw new Error("At least one chain must be specified");
    const e = t.find((n)=>n.id === i.defaultChain?.id), s = {
        projectId: i.projectId,
        networks: t,
        themeMode: i.themeMode,
        themeVariables: $(i.themeVariables),
        chainImages: i.chainImages,
        connectorImages: i.walletImages,
        defaultNetwork: e,
        metadata: {
            ...i.metadata,
            name: i.metadata?.name || "WalletConnect",
            description: i.metadata?.description || "Connect to WalletConnect-compatible wallets",
            url: i.metadata?.url || "https://walletconnect.org",
            icons: i.metadata?.icons || [
    ...
    if (i.mobileWallets?.length || i.desktopWallets?.length) {
        const n = [
            ...(i.mobileWallets || []).map((r)=>({
                    id: r.id,
                    name: r.name,
                    links: r.links
                })),
            ...(i.desktopWallets || []).map((r)=>({
                    id: r.id,
                    name: r.name,
                    links: {
                        native: r.links.native,
                        universal: r.links.universal
                    }
                }))
        ], a = [
            ...s.featuredWalletIds || [],
            ...s.excludeWalletIds || []
        ], o = n.filter((r)=>!a.includes(r.id));
        o.length && (s.customWallets = o);
    }
    return s;
}
function _(i) {
...
//# sourceMappingURL=node_modules_da38de68._.js.map