...
"[project]/app/api/agentkit/abi-configurator/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function classifyFunctions(abi) {
    const funcs = abi.filter((entry)=>entry.type === 'function' && !!entry.name);
    const readFunctions = funcs.filter((entry)=>entry.stateMutability === 'view' || entry.stateMutability === 'pure').map((entry)=>entry.name);
    const writeFunctions = funcs.filter((entry)=>entry.stateMutability !== 'view' && entry.stateMutability !== 'pure').map((entry)=>entry.name);
    return {
...
function detectFeatures(contractKey, readFns, writeFns) {
    const has = (name)=>readFns.includes(name) || writeFns.includes(name);
    const features = [];
...
function tabConfiguration(contractIndex) {
    ...
    return [
        {
            ...
            enabledWrites: token?.writeFunctions.filter((fn)=>[
                    'transfer',
                    'approve'
                ].includes(fn)) || [],
            readDependencies: token?.readFunctions.filter((fn)=>[
                    'balanceOf',
                    'allowance',
                    'name',
                    'symbol'
            ...
            notes: [
                'Token tab is configured from OFT/ERC20 ABI surfaces.'
            ]
        },
        {
            tab: 'bridge',
            ...
            notes: [
                'Bridge tab requires LayerZero OFT send + quote functions.'
            ]
        },
        {
            tab: 'staking',
            ...
            enabledWrites: staking?.writeFunctions.filter((fn)=>[
                    'stake',
                    'unstake',
                    'claimRewards',
                    'compound'
                ].includes(fn)) || [],
            readDependencies: staking?.readFunctions.filter((fn)=>[
                    'earned',
                    'getUserStakeInfo',
                    'totalStaked'
                ].includes(fn)) || [],
            notes: [
                'Staking tab is aligned to ONBTOmnichainStaking methods.'
            ]
        },
        {
            tab: 'governance',
            ...
            enabledWrites: governor?.writeFunctions.filter((fn)=>[
                    'castVote'
                ].includes(fn)) || [],
            readDependencies: governor?.readFunctions.filter((fn)=>[
                    'state',
                    'proposalVotes',
                    'hasVoted',
                    'getVotes'
            ...
            notes: [
                'Governance tab is configured from governor vote/state ABI surfaces.'
            ]
        },
        {
            tab: 'private-sale',
            ...
            enabledWrites: privateSale?.writeFunctions.filter((fn)=>[
                    'buyWithETH',
                    'buyWithToken'
                ].includes(fn)) || [],
            readDependencies: privateSale?.readFunctions.filter((fn)=>[
                    'quotePurchase',
                    'remainingTokens',
                    'paymentTokenEnabled'
                ].includes(fn)) || [],
            notes: [
                'Private sale tab is configured from ONBTPrivateSaleOApp methods.'
            ]
        }
    ];
}
function buildNetworkPayload(network, chainId, contracts) {
...
async function GET(request) {
    ...
    const proof = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$agentkit$2f$walletAccess$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyPrivilegedWalletProof"])(request, 'abi-configurator');
    if (!proof.ok) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
    ...
    const baseContracts = [
        {
            key: 'token',
            address: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_TOKEN_ADDRESS"],
        ...
        {
            key: 'staking',
            address: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_STAKING_ADDRESS"],
        ...
        {
            key: 'privateSale',
            address: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_PRIVATE_SALE_BASE_ADDRESS"],
        ...
        {
            key: 'governor',
            address: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_GOVERNOR_BASE_ADDRESS"],
            abi: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_GOVERNOR_ABI"]
        }
    ];
    const arbitrumContracts = [
        {
            key: 'token',
            address: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_ARBITRUM_ADDRESS"],
            abi: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_TOKEN_ABI"]
        },
        {
            key: 'staking',
            address: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_STAKING_ARBITRUM_ADDRESS"],
            abi: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_STAKING_ABI"]
        },
        {
            key: 'privateSale',
            address: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_PRIVATE_SALE_ARBITRUM_ADDRESS"],
            abi: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_PRIVATE_SALE_ABI"]
        },
        {
            key: 'governor',
            address: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_GOVERNOR_ARBITRUM_ADDRESS"],
            abi: __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$contracts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ONBT_GOVERNOR_ABI"]
        }
    ];
    const networks = [
    ...
    const baseIndex = Object.fromEntries(networks[0].contracts.map((contract)=>[
            contract.key,
            contract
        ]));
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        summary: 'ONBT AI synchronized miniapp module capabilities using deployed Base-hub and Arbitrum-dst contract ABIs.',
        networks,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb8ea684._.js.map